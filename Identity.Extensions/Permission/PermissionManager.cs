...
namespace Identity.Extensions
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public virtual async Task<bool> AuthorizePermissionAsync(List<string> permissions)
        {
            return await Store.AuthorizePermissionAsync(permissions);
        }
        public virtual async Task<bool> AuthorizePermissionAsync(string userName, List<string> permissions)
        {
            return await Store.AuthorizePermissionAsync(userName, permissions);
        }
