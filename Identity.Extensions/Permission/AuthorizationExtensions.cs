...
namespace Identity.Extensions
{
    ...
    {
        public static async Task<bool> AuthorizePermission(this HttpContextBase httpContext, List<string> permissions)
        {
            return await GetPermissionManager(httpContext).AuthorizePermissionAsync(permissions);
        }
